...
if ($swap) {
	...
	$status_str = "Free => $memRealFree, Total => $memRealTotal, Cached => $memRealCached, Buffered => $memRealBuffers Kb|ram_free=$memRealFree ram_total=$memRealTotal ram_cached=$memRealCached ram_buffered=$memRealBuffers";
